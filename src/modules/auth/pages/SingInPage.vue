<template>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" @submit.prevent="iniciarSession">
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">¿No recordas la contraseña?</a>
          </div>
        </div>
        <div class="mt-2">
          <input
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      No tenes cuenta
      <RouterLink :to="{ name: 'singup' }" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
        Registrate
      </RouterLink>
    </p>
  </div>
